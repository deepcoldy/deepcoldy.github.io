...
> Recommended configurations organized by **use case**. For basic usage, see the individual feature pages; for troubleshooting, see [Common pitfalls](/botmux/en/pitfalls.md) and the [FAQ](/botmux/en/faq.md).
...
* You can also stack [scheduled tasks](/botmux/en/schedule.md) for **proactive inspection broadcasts**: `/schedule every day at 9:00 check yesterday's alert trends and summarize`, only @ing people when there's an anomaly.
