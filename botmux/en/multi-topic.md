...
> Related: [multi-bot collaboration](/botmux/en/multi-bot.md) is its infrastructure; use [roles and teams](/botmux/en/roles.md) to give bots roles (who writes, who reviews).
